...
#if defined(NDEBUG)
# error "SucreCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x9a92393aa541ba1b64283b0119e59ffa689283f82d54bf7e5b8218452dd7a5e9");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // SucreCoin: starting difficulty is 1 / 2^12
...
{
    // SucreCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // SucreCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // SucreCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1513343122, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Enero1end";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049fa338500c7f83e53e7360ae30501c51b5a2e149d31bf3d3c72e648d64b54f98e01bcb3e22ad119dd0fe57013a06baa82df18290745c255e47a2c7437b668d0c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513343122;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2412551;
        ...
        assert(block.hashMerkleRoot == uint256("0x7f67647a3a62d2c6f770c1e479dd8bd4e0e61a8bc6ec11d249bb857b5c70129d"));
...
unsigned char pchMessageStart[4] = { 0xef, 0x56, 0xeb, 0x0b }; // SucreCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SucreCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SucreCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static SucreCoinMiner(CWallet *pwallet)
{
    printf("SucreCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("sucrecoin-miner");
    ...
    try { loop {
        ...
        printf("Running SucreCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("SucreCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&SucreCoinMiner, pwallet));
}
